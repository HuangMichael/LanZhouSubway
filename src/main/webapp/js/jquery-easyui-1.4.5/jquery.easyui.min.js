...
_3f7($("body>div.basicMenu:visible").not(".basicMenu-inline"));
});
});
function init(_3f8){
var opts=$.data(_3f8,"menu").options;
$(_3f8).addClass("basicMenu-top");
...
if(_3ff.iconCls){
$("<div class=\"basicMenu-icon\"></div>").addClass(_3ff.iconCls).appendTo(item);
}
if(_3ff.disabled){
_400(_3f8,item[0],true);
}
if(item[0].submenu){
$("<div class=\"basicMenu-rightarrow\"></div>").appendTo(item);
}
_401(_3f8,item);
}
});
...
$(this).find(".basicMenu-text").css({height:(opts.itemHeight-2)+"px",lineHeight:(opts.itemHeight-2)+"px"});
});
...
menu.children("div.basicMenu-line")._outerHeight(_407-2);
};
...
if(!item.hasClass("basicMenu-item")){
return;
}
item.unbind(".menu");
...
menu[0].shadow.css({display:(menu.hasClass("basicMenu-inline")?"none":"block"),zIndex:$.fn.menu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
...
var _422=$("<div class=\"basicMenu\"><div class=\"basicMenu-line\"></div></div>").appendTo("body");
_422.hide();
_421.parent.submenu=_422;
$("<div class=\"basicMenu-rightarrow\"></div>").appendTo(_421.parent);
}
...
$("<div class=\"basicMenu-text\"></div>").html(_421.text).appendTo(item);
}
if(_421.iconCls){
$("<div class=\"basicMenu-icon\"></div>").addClass(_421.iconCls).appendTo(item);
}
if(_421.id){
...
function _42c(_42d){
$(_42d).children("div.basicMenu-item").each(function(){
_423(_42d,this);
});
if(_42d.shadow){
_42d.shadow.remove();
...
return jq.each(function(){
$(_431.target).children("div.basicMenu-text").html(_431.text);
});
},setIcon:function(jq,_432){
return jq.each(function(){
$(_432.target).children("div.basicMenu-icon").remove();
if(_432.iconCls){
$("<div class=\"basicMenu-icon\"></div>").addClass(_432.iconCls).appendTo(_432.target);
}
});
},getItem:function(jq,_433){
var t=$(_433);
var item={target:_433,id:t.attr("id"),text:$.trim(t.children("div.basicMenu-text").html()),disabled:t.hasClass("basicMenu-item-disabled"),name:_433.itemName,href:_433.itemHref,onclick:_433.onclick};
...
function _516(){
if(_512.menu){
var item=_512.menu.children("div.basicMenu-item:first");
_512.menu.children("div.basicMenu-item").each(function(){
...
var menu=$(_576).find(".calendar-basicMenu");
...
$(_581).find(".calendar-basicMenu").show();
if($(_581).find(".calendar-basicMenu-month-inner").is(":empty")){
$(_581).find(".calendar-basicMenu-month-inner").empty();
var t=$("<table class=\"calendar-mtable\"></table>").appendTo($(_581).find(".calendar-basicMenu-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
...
var sele=$(_581).find(".calendar-basicMenu");
var _582=sele.find(".calendar-basicMenu-year-inner");
var _583=sele.find(".calendar-basicMenu-month-inner");

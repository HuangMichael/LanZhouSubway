...
<form class="form-horizontal" id="form" method="post">
    <div class="form-group">
        <div class="col-md-12">
            <div class="form-group">
                <label for="domainName" class="col-md-2 control-label">实体类名称</label>
                <div class="col-md-4">
                    <input class="form-control" id="id" name="id" v-model="tableConfig.id" type="hidden"/>
                    <input class="form-control" id="domainName" name="domainName" v-model="tableConfig.domainName" required/>
                </div>

                <label for="repositoryName" class="col-md-2 control-label">数据接口名称</label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input class="form-control" id="tableDesc" name="tableDesc" v-model="tableConfig.tableDesc" required/>
                </div>

                <label for="tableName" class="col-md-2 control-label">表名称</label>
                <div class="col-md-4">
                    <input class="form-control" id="tableName" name="tableName" v-model="tableConfig.tableName" required/>
                </div>
            </div>
            <div class="form-group">

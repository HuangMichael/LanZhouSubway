...
<th data-column-id="ecName" data-width="15%">易耗品名称</th>
<th data-column-id="location" data-width="15%"  data-converter="showShortLocName">位置</th>
<th data-column-id="amount" data-width="5%">数量</th>
<th data-column-id="applicant" data-width="5%">申请人</th>
<th data-column-id="applyDate" data-width="15%">申请日期</th>

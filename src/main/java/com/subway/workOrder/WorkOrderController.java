...
public class WorkOrderController extends BaseController {
    ...
    public ReturnObject reportFix(@RequestParam("type") String type, @RequestParam("id") Long id, @RequestParam("orderDesc") String orderDesc, @RequestParam(value = "eqClassId", required = false) Long eqClassId, @RequestParam(value = "reporter", required = false) String reporter) {

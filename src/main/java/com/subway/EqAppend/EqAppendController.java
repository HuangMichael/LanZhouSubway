...
return new PageUtils().searchBySortService(eqAppendSearchService, searchPhrase, 1, current, rowCount, pageable);
}
...
List< EqAppend> dataList = eqAppendSearchService.findByConditions(param, 2);
